# Appcodie · Interactive 3D & Floor Plan Showcase
...
Appcodie builds custom web and mobile experiences around the work your users do:

- LiDAR and RoomPlan capture apps, editable floor plans and room measurement tools.
- Interactive 3D websites, architectural explorers and product viewers.
- Inspection apps, photo workflows, dashboards and reporting integrations.
- Custom appraisal software and UAD 3.6 workflow requirements review.
- iOS, Android and Flutter applications with connected APIs and cloud services.
